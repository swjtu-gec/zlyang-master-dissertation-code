...
bpe_processed_dir=${BASE_DIR}/training/zh-bpe-processed-NLPCC_betterseg+HSK-remove-short1-long1000-low0.1-high200.0/
char_processed_dir=${BASE_DIR}/training/zh-char-processed-NLPCC_betterseg+HSK-remove-short1-long1000-low0.1-high200.0/

word_dev_data_dir=${bpe_processed_dir}
char_dev_data_dir=${char_processed_dir}
moses_path=../../mosesdecoder/

BPE_BIN_DATA_DIR=${bpe_processed_dir}/bin/
CHAR_BIN_DATA_DIR=${char_processed_dir}/bin/

char_lm_url=${BASE_DIR}/training/models/lm/wiki_zh.char.5gram.binary.trie
...
model_path=${BASE_DIR}/training/models/fconv_bpe_word2vec_4ens_2_4_5_6
BPE_MODEL_DIR=${BASE_DIR}/training/models/zh_bpe_model_NLPCC_betterseg+HSK_remove_short1_long1000_low0.1_high200.0/
train_reranker_output_dir=${BASE_DIR}/eval/${model_path##*/}_train_reranker_${reranker_feats}
DATA_BIN_DIR=${BPE_BIN_DATA_DIR}
test_input=${jieba_seg_test_input}
run_models_output_dir=${BASE_DIR}/eval/${model_path##*/}_${reranker_feats}
...
#model_path=${BASE_DIR}/training/models/fconv_char_random_4ens_1_2_4_1000
#BPE_MODEL_DIR=None
#train_reranker_output_dir=${BASE_DIR}/eval/${model_path/##*/}_train_reranker_${reranker_feats}

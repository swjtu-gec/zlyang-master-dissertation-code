...
# ============================
M1_output=${output_dir}/M1.fairseq.output.nbest.txt
...
# ==============================================
M2_output=${output_dir}/M2.fairseq.output.nbest.txt
if [[ ! -e ${M2_output} || ${force_redo_translation} == true ]]; then
...
# ===========================
M3_output=${output_dir}/M3.fairseq.output.nbest.txt
if [[ ! -e ${M3_output} || ${force_redo_translation} == true ]]; then
...
# ==============================================
M4_output=${output_dir}/M4.fairseq.output.nbest.txt
if [[ ! -e ${M4_output} || ${force_redo_translation} == true ]]; then

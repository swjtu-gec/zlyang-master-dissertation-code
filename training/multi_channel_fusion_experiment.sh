...
multi_channel_fusion_train_reranker_output_dir=${BASE_DIR}/eval/multi_channel_fusion_train_reranker_${inference_mode}_${channel_output_mode/-/}/
char_lm_url=${BASE_DIR}/training/models/lm/wiki_zh.char.5gram.binary.trie

test_input_char_file=${BASE_DIR}/data/test/nlpcc2018-test/char.seg.txt
multi_channel_translation_output_dir=${BASE_DIR}/eval/multi_channel_translation_${inference_mode}_${channel_output_mode/-/}/
